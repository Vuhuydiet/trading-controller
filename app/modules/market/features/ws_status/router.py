...
@router.get(
    ...
    description="Retrieve the current status of the WebSocket connection to Binance including connection state, subscribed streams, and cache statistics."
)
async def get_websocket_status(user = Depends(get_current_user_dto)):
